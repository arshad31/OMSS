    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h3 class="m-0 text-center text-dark">Committees</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <?php if($row["is_active"] != 0 ){?>
                                <tr class="text-center">
                                    ...
                                    <td class="text-center">
                                        <a href="committees-details.php?committee_id=<?php echo $row["committee_id"];?>" class="btn btn-dark btn-sm" type="submit">View</a>
                                    </td>
                                </tr>
                            <?php }?>
                        <?php } ?>
