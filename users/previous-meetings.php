<?php
    ...
    $meetingsData = $user->getPreviousMeetingsByUserID($userID);
?>
                ...
                <div class="col-sm-10 offset-1">
                    <table class="table table-hover table-bordered table-sm">
                        ...
                        <tr >
                            ...
                            <td>
                                <?php if($row["m_action"]==1 OR $row["m_action"]==2){?>
                            ...
                            <td class="text-center " >
                                <a href="previous-meetings-details.php?meeting_id=<?php echo $row["meeting_id"];?>" class="btn btn-dark btn-sm mt-lg-3" type="submit">View</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
