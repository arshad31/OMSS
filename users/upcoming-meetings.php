<?php
    ...
    $meetingsData = $user->getUpcomingMeetingsByUserID($userID);
?>
                ...
                <div class="col-sm-10 offset-1">
                    <table class="table table-hover table-bordered table-sm">
                        ...
                        <tr >
                            ...
                            <td class="text-center " >
                                <a href="meetings-details.php?meeting_id=<?php echo $row["meeting_id"];?>" class="btn btn-dark btn-sm mt-lg-3"  type="submit">View</a>
                            </td>
                        </tr>
                        <?php } ?>
                        </tbody>
